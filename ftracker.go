...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	// return ((18 * СредняяСкоростьВКм/ч * 1.79) * ВесСпортсменаВКг / mInKM  * ВремяТренировкиВЧасах * minInH)
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	// meanSpeed(action,duration) // км/ч
	// meanSpeed(action,duration) * kmhInMsec // м/с
	// math.Pow(x, 2) == x**2
